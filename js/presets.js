...
// no fun" feedback. Also callable by the agent via the synth_load_preset tool.
...
const PRESETS = [
  {
    ...
    filter: { cutoff: 1400, resonance: 1, type: 'lowpass', envAmount: 0 },
  ...
  },
  {
    ...
    filter: { cutoff: 900, resonance: 3, type: 'lowpass', envAmount: 0 },
  ...
  },
  {
    ...
    filter: { cutoff: 1100, resonance: 2, type: 'lowpass', envAmount: 0 },
  ...
  },
  {
    ...
    // A real filter-envelope pluck, not just a static bright cutoff: rests
    // at 800 Hz, snaps up 3 octaves (to ~6400 Hz, close to this preset's old
    // static cutoff) on attack, then decays back down toward the sustain
    // level — the classic "pluck" motion the name has always implied.
    filter: { cutoff: 800, resonance: 4, type: 'lowpass', envAmount: 3 },
  ...
  },
  {
    ...
    filter: { cutoff: 1800, resonance: 0.5, type: 'lowpass', envAmount: 0 },
  ...
  },
  {
    ...
    filter: { cutoff: 3200, resonance: 5, type: 'lowpass', envAmount: 0 },
